...
| **Coverage** | `make cover` | Statement coverage **≥ 80%** (SPEC §6.1); writes `coverage.out` |
| **Release gate** | `make release-check` | lint, test, cover, security, docker-scan (requires Docker) |
